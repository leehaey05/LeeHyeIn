...
| --- | --- | --- |
| 화살표 키로 우주선을 좌우로 이동. | 외계인이 좌우로 이동하며 
점점 아래로 내려옵니다. | 모든 외계인을 처치하면 
"!!CLEAR!!" 메시지와 함께 승리. |
| 스페이스바를 눌러 빔 발사. | 외계인이 무작위로 폭탄을 투하하며 
플레이어가 피해야 합니다. | 외계인이 화면 아래로 내려오거나 폭탄에 맞으면
"!!YOU DIED!!" 메시지와 함께 게임 종료. |
